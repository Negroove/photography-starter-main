      ...
      gap-x-24 text-center lg:text-left pt-24 lg:pt-36 pb-8"
        ...
        {/*texto*/}
          <div className="flex flex-col lg:items-start ">
            ...
            <p className="mb-12 max-x-sm">
              Lorem ipsum dolor sit amet, consectetur adipi scing elit. Nulla
              <br />
              <br />
              Pellentesque iaculis egestas cursus. Phasellus quam nisi,
              facilisis eget dapibus acerat.
            </p>
          ...
          <div className="grid grid-cols-2 lg:gap-2">
            ...
            h-[187px] lg:h-[220px] bg-accent overflow-hidden">
             ...
             hover:scale-110 transition-all duration-500 "
                ...
                alt=""
              ></img>
            </div><div className="max-w-[250px] lg:max-w-[320px] 
            h-[187px] lg:h-[220px] bg-accent overflow-hidden">
              <img
                className="object-cover h-full lg:h-[220px]
             hover:scale-110 transition-all duration-500 "
